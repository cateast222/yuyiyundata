 ...
 */
package com.yuyiyun.YYdata.core.aop;
...
import com.yuyiyun.YYdata.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.yuyiyun.YYdata.core.common.annotion.BussinessLog)")
