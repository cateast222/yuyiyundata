 ...
 */
package com.yuyiyun.YYdata.modular.system.warpper;

import com.yuyiyun.YYdata.core.common.constant.factory.ConstantFactory;
import com.yuyiyun.YYdata.core.util.DecimalUtil;
...
public class UserWrapper extends BaseControllerWrapper {
    ...
    protected void wrapTheMap(Map<String, Object> map) {
        map.put("sexName", ConstantFactory.me().getDictsByName("性别",(String) map.get("sex")));//.getSexName((String) map.get("sex")));
